...
const projects = [
  {
    ...
    tags: ['#blog'],
    links: [
      { name: 'github', url: 'https://github.com/rozenmd/react-portfolio' },
    ],
    year: 2017,
    image: null,
    internal: true,
  ...
  },
  {
    ...
    tags: ['#project'],
    links: [
      { name: 'github', url: 'https://github.com/rozenmd/CanIGoOutsideYet' },
    ],
    year: 2015,
    image: null,
    internal: true,
  },
  {
    title: 'NGHBR',
    titleFont: '',
    description: 'A hyperlocal social network',
    uri: '/projects/nghbr',
    tags: ['#project'],
    links: [{ name: 'github', url: 'https://github.com/rozenmd/NGHBR' }],
    year: 2015,
    image: null,
    internal: true,
  },
