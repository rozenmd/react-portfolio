        ...
        return (
            <div id="billdivider">
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <p>
                            So I made a little extension to the React app that hosts my blog and portfolio site - Now
                            I'll be able to both blog and post projects, without making the UX a pain!
                        </p>
                        <p>
                            My next goal with the filtering will be to grab the unique set of tags that my posts use to
                            filter. So watch this space for data visualisation posts!
                        </p>
