  ...
  return (
    <div className="row img-container">
      <div className="row about-text">
        <p className="lead">
          My name is Max Rozen, I'm a Full Stack Software Engineer, with a focus
          on Data Engineering for Analytics Platforms at EYC3. Much of my work
          lies in the backend using Python, though I've been known to help out
          on the front-end in AngularJS and React.
        </p>
