  ...
  render() {
    ...
    return (
      <ul className="home-nav">
        <li>
          <a className="custom-link" data-name="about" onClick={onClick}>
            ABOUT
          </a>
        </li>
        <li>
          <a className="custom-link" data-name="projects" onClick={onClick}>
            PROJECTS
          </a>
        </li>

        <li>
          <a className="custom-link" href="https://maxrozen.com/legacy/blog/">
            LEGACY
          </a>
        </li>
        <li>
